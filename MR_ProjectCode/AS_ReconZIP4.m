...
%
% Andrew Simon
% Nov 8, 2022 - Section labeling & output filename change
...
%% Apodization, Chopping, K-space Zero-padding (Mesh plot & K-space)
...
zip_factor = 2; % Zero pad by factor of 2 for 1024x1024
...
%% Magnitude & Phase image transform/plotting
...
info.StudyID = exam;
info.SeriesNumber= series*100 + 50;
...
new_dfile = strcat('e',info.StudyID,'s',int2str(info.SeriesNumber),'i', int2str(info.InstanceNumber), '_zeropad', '.dcm');
